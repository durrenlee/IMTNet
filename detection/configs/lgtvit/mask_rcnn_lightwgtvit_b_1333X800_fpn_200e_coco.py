...
data_root = '/root/workspace/coco2017/'
...
# ]
param_scheduler = [
    dict(type='LinearLR', start_factor=0.1, by_epoch=True, begin=0, end=60),
    dict(
        T_max=140,   # iters/epochs from crest to trough or trough to crest
        begin=60,
        by_epoch=True,
        convert_to_iter_based=True,
        end=200,
