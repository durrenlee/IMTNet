...
class CocoMetric(BaseMetric):
    ...
    def results2json(self, results: Sequence[dict],
        ...
        for idx, result in enumerate(results):
            ...
            for i, label in enumerate(labels):
                ...
                # one prediction data of 100 predicted result by score desc order:
                # {'image_id': 91,
                # 'bbox': [2556.0693359375, 766.648681640625, 865.094482421875, 419.168212890625],
                # 'score': 0.3424423038959503,
                # 'category_id': 0}
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        # print(f'self._coco_api.cats:{self._coco_api.cats}')
        # print(f'self._coco_api.dataset:{self._coco_api.dataset}')
        # print(f'self._coco_api.get_ann_ids():{self._coco_api.get_ann_ids()}')
        # print(f'self._coco_api.get_img_ids():{self._coco_api.get_img_ids()}')
        # print(f'self.metrics:{self.metrics}')
        # print(f'self.iou_thrs:{self.iou_thrs}')
        # print(f'self.classwise:{self.classwise}')
        ...
        # result_files:{'bbox': '/tmp/tmpybmjm90j/results.bbox.json', 'proposal': '/tmp/tmpybmjm90j/results.bbox.json'}
        ...
        for metric in self.metrics:
            ...
            try:
                ...
                print(f'loading predictions[0]:{predictions[0]}')
                if iou_type == 'segm':
            ...
            metric_items = self.metric_items # metric_items:None
