...
def anchor_inside_flags(flat_anchors: Tensor,
    ...
    Returns:
        torch.Tensor: Flags indicating whether the anchors are inside a \
            valid range.
    """
    # print(f'anchor_inside_flags>>valid_flags:{valid_flags}, len:{len(valid_flags)}')
    # valid_flags:tensor([ True,  True,  True,  ..., False, False, False], device='cuda:0'), len:22300
    ...
    # print(f'utils.py>>inside_flags:{inside_flags}, len:{len(inside_flags)}')
