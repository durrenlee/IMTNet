...
class TaskAlignedAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        # print(f'pred_instances.bboxes: {pred_instances.bboxes.shape}')
        # print(f'pred_instances.scores: {pred_instances.scores.shape}')
        gt_bboxes = gt_instances.bboxes
        gt_labels = gt_instances.labels
        # print(f'gt_instances.bboxes: {gt_instances.bboxes.shape}')
        # print(f'gt_instances.labels: {gt_instances.labels}')
        ...
        # print(f'alignment_metrics shape: {alignment_metrics.shape}')
