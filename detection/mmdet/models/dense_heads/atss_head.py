...
class ATSSHead(AnchorHead):
    ...
    def loss_by_feat(
        ...
        # print(f'atss_head>>featmap_sizes:{featmap_sizes}, len:{len(featmap_sizes)}')
    ...
    def _get_targets_single(self,
        ...
        if unmap_outputs:
            ...
            # print(f'label_weights:{label_weights}, len: {len(label_weights)}')
            # label_weights:tensor([1., 1., 1.,  ..., 1., 1., 1.], device='cuda:0'), len: 22300
            # label_weights: tensor([1., 1., 1., ..., 1., 1., 1.], device='cuda:0'), len: 13343
            # print(f'num_total_anchors:{num_total_anchors}')
            # num_total_anchors:22300
            # print(f'inside_flags:{inside_flags}, len:{len(inside_flags)}')
            # inside_flags:tensor([True, True, True,  ..., True, True, True], device='cuda:0'), len:22300
            # inside_flags:tensor([ True,  True,  True,  ..., False, False, False], device='cuda:0'), len:22300
        ...
        # print(f'label_weights = unmap()=>label_weights:{label_weights}, len:{len(label_weights)}')
        # label_weights = unmap()=>label_weights:tensor([1., 1., 1.,  ..., 1., 1., 1.], device='cuda:0'), len:22300
