...
class AnchorHead(BaseDenseHead):
    ...
    def get_anchors(self,
        ...
        for img_id, img_meta in enumerate(batch_img_metas):
            # print(f'featmap_sizes:{featmap_sizes}, len:{len(featmap_sizes)}')
            # featmap_sizes:[torch.Size([100, 167]), torch.Size([50, 84]), torch.Size([25, 42]),
            # torch.Size([13, 21]), torch.Size([7, 11])], len:5
            # print(f'img_meta:{img_meta}')
            # img_meta['pad_shape']:(800, 1333)
            # img_meta['pad_shape']:(800, 1333)

            multi_level_flags = self.prior_generator.valid_flags(
                featmap_sizes, img_meta['pad_shape'], device)
            # print(f'multi_level_flags:{multi_level_flags}, len:{len(multi_level_flags)}')
            # multi_level_flags:[tensor([True, True, True,  ..., True, True, True], device='cuda:0'),
            # tensor([True, True, True,  ...len:5
            valid_flag_list.append(multi_level_flags)

        # print(f'creating valid_flag_list:{valid_flag_list}, len:{len(valid_flag_list)}')
    ...
    def loss_by_feat(
        ...
        # print(f'anchor_head>>featmap_sizes:{featmap_sizes}, len:{len(featmap_sizes)}')
